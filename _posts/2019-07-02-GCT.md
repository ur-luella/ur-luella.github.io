...
## Method
### Graph로 변환된 EHR
방문 노드들인 v가 존재하고 그 아래 diagnosis 노드인 d,..., treatment 노드인 m..이 존재합니다. 몇몇의 treatment에는 lab 결과인 r, ..가 존재하고 혈압과 같은 연속값과 알러지 반응 유무와 같은 이진값을 갖습니다. 만약 d, m, r을 같은 크기의 latent space로 재표현한다면 이 3가지의 카테고리로 이루어져 있는 |d|+|m|+|r|의 인접행렬 A를 볼 수 있습니다. c는 d, m, r을 총칭한 용어입니다.
